...
void loop()
{
  ...
  int CurrentxRate, CurrentyRate, CurrentzRate;
  //Read the x,y and z output rates from the gyroscope.
  CurrentxRate = readX();
  CurrentyRate = readY();
  CurrentzRate = readZ();
  //Print the output rates to the terminal, seperated by a TAB character.
  if(CurrentxRate >= x + 200 || CurrentyRate >= y+200 || CurrentyRate < x - 200 ){
    isTilted = true;
  ...
  Serial.print(CurrentxRate);
  Serial.print('\t');
  Serial.print(CurrentyRate);
  Serial.print('\t');
  Serial.println(CurrentzRate);  
